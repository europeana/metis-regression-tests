...
public class Firefox_Test {
    ...
    public void FirefoxTest() throws InterruptedException, IOException {
        ...
        //Upload a Dataset
        driver.findElement(By.id("name")).sendKeys("Automation_Illegal_Enrichment_Firefox_Release_V9");
        {
        ...
        chooseFile.sendKeys("C:\\Users\\Deepti Pandit\\IdeaProjects\\Sandbox-Regression\\Records\\llegal_enrichment_character.zip");
