...
public class Firefox_Test {
    ...
    public void FirefoxTest() throws InterruptedException, IOException {
        ...
        Thread.sleep(3000);
        driver.findElement(By.id("dataset-name")).sendKeys("Automation_Duplicates_Firefox_regression_MET6320");
        ...
        //Upload http file
        driver.findElement(By.cssSelector("#url")).sendKeys("https://metis-repository-rest.test.eanadev.org/repository/zip/deepti_duplicates.zip");
