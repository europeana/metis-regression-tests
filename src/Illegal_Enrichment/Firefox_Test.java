...
public class Firefox_Test {
    ...
    public void FirefoxTest() throws InterruptedException, IOException {
        ...
        Thread.sleep(3000);
        driver.findElement(By.id("dataset-name")).sendKeys("Automation_Firefox_Illegal_Enrichment_Regression_Test_MET5579");
        ...
        //Upload http file
        driver.findElement(By.cssSelector("#url")).sendKeys("https://metis-repository-rest.test.eanadev.org/repository/zip/deepti_illegal_enrichment.zip");
