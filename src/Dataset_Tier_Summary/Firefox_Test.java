...
public class Firefox_Test {
    ...
    @Test
    public void FirefoxTest() throws InterruptedException, IOException, AWTException {
        ...
        //Upload a Dataset
        driver.findElement(By.id("name")).sendKeys("Automation_All_types_Firefox_Dataset_Tier_Summary_Release_V9");
        {
