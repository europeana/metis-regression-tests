...
public class Firefox_Test {
    ...
    public void FirefoxTest() throws InterruptedException, IOException {
        ...
        //Upload a Dataset
        driver.findElement(By.id("name")).sendKeys("Automation_All_types_Firefox_Date_Normalization_Release_V9");
        {
        ...
        chooseFile.sendKeys("C:\\Users\\Deepti Pandit\\IdeaProjects\\Sandbox-Regression\\Records\\Date_Normalization_record_1.zip");
